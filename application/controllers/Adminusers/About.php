...
{  
      function __construct()
  {
    ...
    public function index(){
        ...
        $data['h']=$this->Adminuser ->select_Record('about');
        $this->load->view('adminuser/header');
        $this->load->view('adminuser/about',$data);
   ...
   public function update_about()
        {
          ...
          if($this->form_validation->run())
          {
            ...
            $this->Adminuser->update_global_Record('about',$id,$updateArray);
            $this->session->set_flashdata('update','Your details has been updated');
            redirect('Adminusers/About');
          }
          else
          {
            echo "hello";
