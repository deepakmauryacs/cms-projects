...
{  
      function __construct()
  {
    ...
    public function index(){
        ...
        $data['h']=$this->Adminuser ->select_Record('indexabout');
        $this->load->view('adminuser/header');
        $this->load->view('adminuser/indexabout',$data);
        $this->load->view('adminuser/footer');
                  }

  
   public function update_indexabout()
        {
          ...
          if($this->form_validation->run())
          {
            ...
            $this->Adminuser->update_global_Record('indexabout',$id,$updateArray);
            $this->session->set_flashdata('update','Your details has been updated');
            redirect('Adminusers/Indexabout');
          }
          else
          {
            echo "hello";
