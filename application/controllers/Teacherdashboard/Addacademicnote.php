 ...
 * 
 */
class Addacademicnote  extends CI_Controller 
{  
     function __construct()
  {
    ...
    $this->load->model('Adminuser');
     ...
     public function view_academic_note(){
        ...
        $this->load->view('teacherdashboard/header');
        $this->load->view('teacherdashboard/viewall_enote_book',$data);
        $this->load->view('teacherdashboard/footer');
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      echo("hello");
        ...
        redirect(base_url().'Teacherdashboard/Addacademicnote');
    }
   ...
   public function update_academic_note()
        {
          ...
          if($this->form_validation->run())
          {
            ...
            // print_r($updateArray);
            // die();
            $this->Adminuser->update_global_Record('academy_note',$id,$updateArray);
            $this->session->set_flashdata('update','Your details has been updated');
            redirect(base_url().'Teacherdashboard/Addacademicnote/view_academic_note');
          }
          else
          {
              echo "hello";
        ...
        public function delete_academic_note($id)
         ...
         $this->Adminuser->delete_Record('academy_note',$id);
