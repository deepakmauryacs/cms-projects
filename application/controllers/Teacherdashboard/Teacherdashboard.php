...
{  
     function __construct()
  {
    ...
    $this->load->model('Adminuser');
        ...
        $this->load->view('teacherdashboard/index');
        $this->load->view('teacherdashboard/footer');
          ...
          public function Userprofile(){
            ...
            $data['h']=$this->Adminuser ->selectRecord('teacher', ['emailid'=>$teddata['emailid']]);
            // print_r($data);die;
         
            $this->load->view('teacherdashboard/header');
            $this->load->view('teacherdashboard/user_profile',$data);
            $this->load->view('teacherdashboard/footer');
           }
