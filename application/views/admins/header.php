	                    ...
	                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item ">
	                                    <a href="<?php echo base_url(); ?>Admins/Onlineadmission/viewallonlineaddmission" class="nav-link ">
	                                        <span class="title">All Admission</span>
	                                    </a>
	                                </li>
                                    <li class="nav-item ">
                                        <a href="<?php echo base_url(); ?>Admins/Onlineverification/viewonlineverification" class="nav-link ">
                                            <span class="title">All Verification</span>
                                        </a>
                                    </li>
	                            </ul>
	                        </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Admins/Addstudent" class="nav-link ">
                                            <span class="title">Add Student</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Admins/Addstudent/viewallstudent" class="nav-link ">
                             ...
                             <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Admins/Addteacher" class="nav-link ">
                                            <span class="title">Add Teacher</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Admins/Addteacher/viewallteacher" class="nav-link ">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Admins/Addnotice" class="nav-link ">
                                            <span class="title">Add Notice</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Admins/Addnotice/viewnotice" class="nav-link ">
                             ...
                             <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Admins/Addvideoacdemic1" class="nav-link ">
                                            <span class="title">Add Video Course</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Admins/Addvideoacdemic1/viewallvideoacdemic1" class="nav-link ">
