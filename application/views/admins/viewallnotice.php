                                       ...
                                       <td><?php echo $row->notice ; ?></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-tbl-edit btn-xs" data-toggle="modal" data-target="#largeModel<?=$row->id?>">
                                                     ...
                                                     <a onclick="return confirm('Are you sure?')"  href="<?php echo base_url().'Admins/Addnotice/delete_notice/'.$row->id  ?>" class="btn btn-tbl-delete btn-xs">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <form action="<?php echo base_url('Admins/Addnotice/update_notice');?>" method="post" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
