                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <form action="<?php echo base_url('Admins/Addteacher/update_teacher');?>" method="post" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Teachername Name
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" name="teachername" data-required="1" value="<?php echo $row->teachername; ?>"  class="form-control input-height" required> </div>
                                            </div>


                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Aadharnumber
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" name="aadharnumber" data-required="1" value="<?php echo $row->aadharnumber; ?>" class="form-control input-height" required> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="specialist" data-required="1" value="<?php echo $row->specialist; ?>" class="form-control input-height" required> </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Teacher Contact Number
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" name="contactnumber" value="<?php echo $row->contactnumber; ?>" data-required="1"  class="form-control input-height" required> </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Teacher Email Id
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" name="emailid" value="<?php echo $row->emailid; ?>" data-required="1"  class="form-control input-height" required> </div>
                                            </div>
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="password" value="<?php echo $row->password; ?>" data-required="1"  class="form-control input-height" required> </div>
                                            </div>
