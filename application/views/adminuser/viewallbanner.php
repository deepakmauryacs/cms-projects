                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">All Banner</div>
                            </div>
                                ...
                                <div class="card-body ">
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                  <td><?php echo $i++;?></td>
                                       <td> <img src="<?php echo base_url().'/uploads/banner/'.$row->image; ?>" style="width: 50px;height: 50px;" ></td>
                                       ...
                                       <td><?php echo $row->status ; ?></td>
                                                <td>
                                                    <a class="btn btn-tbl-edit btn-xs" data-toggle="modal" data-target="#largeModel<?=$row->id?>">
                                                     ...
                                                     <a href="<?php echo base_url().'Adminusers/Banner/delete_banner/'.$row->id  ?>" class="btn btn-tbl-delete btn-xs">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <form action="<?php echo base_url('Adminusers/Banner/update_banner');?>" method="post" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="heading" data-required="1"  value="<?php echo $row->heading ; ?>" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="subheading" data-required="1" value="<?php echo $row->subheading ; ?>"  class="form-control input-height" /> </div>
                                            </div>
