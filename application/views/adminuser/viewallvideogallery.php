                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>All  Video Gallery</header>
                                    <div class="tools">
                                       ...
                                       <td><?php echo $row->videolink ; ?></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-tbl-edit btn-xs" data-toggle="modal" data-target="#largeModel<?=$row->id?>">
                                                     ...
                                                     <a onclick="return confirm('Are you sure?')"  href="<?php echo base_url().'Adminusers/Addvideogallery/delete_videogallery/'.$row->id  ?>" class="btn btn-tbl-delete btn-xs">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <form action="<?php echo base_url('Adminusers/Addvideogallery/update_videogallery');?>" method="post" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="videolink" data-required="1"  value="<?php echo $row->videolink; ?>" class="form-control input-height" /> </div>
                                            </div>
