            ...
            <div class="row">
                <div class="blog-items">
                    <div class="blog-content col-md-9">
                        <!-- Single Item -->
                       <h3 class="text-center">Academic Video Courses</h3>
                        ...
                        <div class="row">
                        	...
                        	<div class="col-md-4 text-center">
							 <input type="submit" class="btn btn-warning btn-xs" style="width: 70%; min-height: 37px; margin-top:-5px;" value="search"> 
