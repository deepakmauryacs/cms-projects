  ...
  <!-- Start Breadcrumb 
    ...
    <div class="breadcrumb-area shadow dark text-center bg-fixed text-light" style="background-image: url(<?php echo base_url(); ?>assetes/assets/img/banner/12.jpg); padding-top: 40px;padding-bottom: 40px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Academic Previous Years Papers</h1>
                    <ul class="breadcrumb">
                    ...
                    <div class="mid">
                        ...
                        <div class="col-md-4">
                        	<div class="cards noselect"> 
                        		...
                        		<h4 style="padding-top: 10px;"><?php echo $row->subjectname ; ?> Class <?php echo $row->class ; ?>th....</h4>
                        		<hr>
                                <?php echo $row->note ; ?>
								<hr>
								<p class="text-center" style="padding-top: 10px; color: #ccc;"><?php echo $row->date ; ?></p>
