  ...
  <!-- Start Breadcrumb 
    ...
    <div class="breadcrumb-area shadow dark text-center bg-fixed text-light" style="background-image: url(<?php echo base_url(); ?>assetes/assets/img/banner/12.jpg); padding-top: 40px;padding-bottom: 40px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Competitive Exams  E-Book</h1>
                    <ul class="breadcrumb">
            ...
            <div class="row">
                <div class="blog-items">
                    <div class="blog-content col-md-9">
                        <!-- Single Item -->
                       <h3 class="text-center">Competitive Exams</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <div class="mid">
                        <center>
                        <a class="md-btn" href="<?php echo base_url(); ?>Course/Course/competitiveexams_book">E-Book</a>
                        <a class="md-btn" href="<?php echo base_url(); ?>Course/Course/academicnote">E-Note</a>
                        <a class="md-btn" href="<?php echo base_url(); ?>Course/Course/competitiveexams_video">Video</a>
                        </center>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <center>
                        	<div class="col-md-6"><input type="text" class="form-control" style="min-height: 30px;" placeholder="Subject"></div>
                        ...
                        <div class="col-md-4">
                        	<div class="cards noselect"> 
                        		...
                        		<h4 style="padding-top: 10px;"><?php echo  $value['subject'];  ?> For <?php echo  $value['examname']; ?>....</h4>
                        		<hr>
                                <?php echo $value['description']; ?>
								<hr>
								<p class="text-center" style="padding-top: 10px; color: #ccc;"><?php echo  $value['subject']  ?></p>
                        ...
                        <aside>
                            ...
                            <div class="sidebar-item category">
                                ...
                                <div class="sidebar-info">
                                    <ul>
                                        <li>
                                            <a href="#">UPSC <span>23</span></a>
                                        </li>
                                        <li>
                                            <a href="#">SSC <span>10</span></a>
                                        </li>
                                        <li>
                                            <a href="#">Banking <span>12</span></a>
                                        </li>
                                        <li>
                                            <a href="#">Railway <span>17</span></a>
                                        </li>
                                        <li>
                                            <a href="#">Defence <span>0</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
