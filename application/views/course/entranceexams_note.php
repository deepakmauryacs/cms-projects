  ...
  <!-- Start Breadcrumb 
    ...
    <div class="breadcrumb-area shadow dark text-center bg-fixed text-light" style="background-image: url(<?php echo base_url(); ?>assetes/assets/img/banner/12.jpg); padding-top: 40px;padding-bottom: 40px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Entranceexams E-Note</h1>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="fas fa-home"></i> Home</a></li>
                        <li class="active">E-Note</li>
                    </ul>
                </div>
            </div>
         </div>
            ...
            <div class="row">
                <div class="blog-items">
                    <div class="blog-content col-md-9">
                        <!-- Single Item -->
                       <h3 class="text-center">Entranceexams</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <div class="mid">
                        <center>
                        <a class="md-btn" href="<?php echo base_url(); ?>Course/Course/entranceexams_book">E-Book</a>
                        <a class="md-btn" href="<?php echo base_url(); ?>Course/Course/entranceexams_note">E-Note</a>
                        <a class="md-btn" href="<?php echo base_url(); ?>Course/Course/entranceexams_video">Video</a>
                        </center>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-4">
                        	<div class="cards noselect"> 
                        		...
                        		<h4 style="padding-top: 10px;"><?php echo  $value['subjectname'];  ?> For <?php echo  $value['examname']; ?>....</h4>
                        		<hr>
                                <?php echo $value['note']; ?>
								<hr>
								<p class="text-center" style="padding-top: 10px; color: #ccc;"><?php echo  $value['date']  ?></p>
                        ...
                        <aside>
                            ...
                            <div class="sidebar-item category">
                                ...
                                <div class="sidebar-info">
                                    <ul>
                                        <li>
                                            <a href="#">CAT <span>23</span></a>
                                        </li>
                                        <li>
                                            <a href="#">MAT <span>10</span></a>
                                        </li>
                                        <li>
                                            <a href="#">NDA <span>12</span></a>
                                        </li>
                                        <li>
                                            <a href="#">JEE <span>17</span></a>
                                        </li>
                                        <li>
                                            <a href="#">GATE <span>0</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
