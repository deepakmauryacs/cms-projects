                                        ...
                                        <div class="col-menu col-md-4">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="#">Class 1st - 10th</a></li>
                                                    <li><a href="#">Class 11th & 12th</a></li>
                                                    <li><a href="#">UG Course</a></li>
                                                    <li><a href="#">Class 11th & 12th</a></li>
                                                </ul>
                                            </div>
                                        </div><!-- end col-3 -->
                                        <div class="col-menu col-md-4">
                                            <h6 class="title">Online Exam</h6>
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="#">college exam</a></li>
                                                    <li><a href="#">Goverment Exam</a></li>
                                                    <li><a href="#">GK and GS Exam</a></li>
                                                    <li><a href="#">Other Exam</a></li>
                                                </ul>
                                            </div>
                                        </div><!-- end col-3 -->
                                        <div class="col-menu col-md-4">
