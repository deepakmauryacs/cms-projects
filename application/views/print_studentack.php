            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <form action="#" id="login-form" class="white-popup-block">
                        ...
                        <div class="col-md-12" style="background-color: #ffb606;text-align: center; margin-bottom: 20px; height: 45px;">
                            <h4 style="color: white; margin-top: 8px;">Print Acknowledgement</h4>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Enter Your Enrollment No*" type="email">
                                    </div>
                                </div>
                            </div>
