                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Sample papers</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">Sample papers</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Add Sample papers</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Add Sample papers</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="<?php echo base_url('Teacherdashboard/Addsamplepapers/add_samplepapers');?>" method="post" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
                                           
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Sample  
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="year" data-required="1"  class="form-control input-height"  required> </div>
                                            </div>
