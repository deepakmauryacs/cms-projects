                        ...
                        <!-- end message dropdown -->
 						...
 						<li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <a href="<?php echo base_url('Teacherdashboard/Teacherdashboard/Userprofile');?>">
                                ...
                                <li>
                                    <a href="<?php echo base_url('Admins/teacherlogin/logout');?>">
	                ...
	                <div id="remove-scroll" class="left-sidemenu">
	                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="sidebar-user-panel">
	                            <div class="user-panel">
	                                ...
	                                <div class="pull-left info">
	                                    <p>
                                        <?php
                                        $teddata=$this->session->userdata('TeacherData');
                                        echo($teddata['teachername']);
                                        ?>
                                         </p>  
	                                    <small>Teacher</small>
	                                </div>
                            ...
                            <li class="nav-item active open">
                                <a href="<?php echo base_url(); ?>Teacherdashboard/Teacherdashboard" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="nav-item ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addliveclass" class="nav-link ">
                                            <span class="title">Add Live Class</span>
                                        </a>
                                    </li>
                                    <li class="nav-item ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addliveclass/view_liveclass" class="nav-link ">
                                            <span class="title">All Live Class</span>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link nav-toggle">
                                    <i class="material-icons">dashboard</i>
                                    <span class="title">Course 6th – 12th </span>
                                    <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addacademicbook" class="nav-link ">
                                            <span class="title">Add Books </span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addacademicbook/view_academic_book" class="nav-link ">
                                            <span class="title">All Books</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addsolutions" class="nav-link ">
                                            <span class="title">Add Solutions </span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addsolutions/view_solutions" class="nav-link ">
                                            <span class="title">All Solutions</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addacademicnote" class="nav-link ">
                                            <span class="title">Add Notes </span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addacademicnote/view_academic_note" class="nav-link ">
                                            <span class="title">All Notes </span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addacademicvideo" class="nav-link ">
                                            <span class="title">Add Video lectures</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addacademicvideo/viewallacademicvideo" class="nav-link ">
                                            <span class="title">All Video lectures</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addpreviousyearpapers" class="nav-link ">
                                            <span class="title">Add Previous years papers</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addpreviousyearpapers/view_previousyearpapers" class="nav-link ">
                                            <span class="title">All Previous years papers</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addsamplepapers" class="nav-link ">
                                            <span class="title">Add Sample papers</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addsamplepapers/view_samplepapers" class="nav-link ">
                                            <span class="title">All Sample papers</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="#" class="nav-link ">
                                            <span class="title">Add Test series</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="#" class="nav-link ">
                                            <span class="title">All Test series</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addexambook" class="nav-link ">
                                            <span class="title">Add Books </span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addexambook/view_exam_book" class="nav-link ">
                                            <span class="title">All Books</span>
                                        </a>
                                    </li>
                                
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addexamnote" class="nav-link ">
                                            <span class="title">Add Notes </span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addexamnote/view_exam_note" class="nav-link ">
                                            <span class="title">All Notes </span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addexamvideo" class="nav-link ">
                                            <span class="title">Add Video lectures</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addexamvideo/viewallexamvideo" class="nav-link ">
                                            <span class="title">All Video lectures</span>
                                        </a>
                                    </li>
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item ">
	                                    <a href="<?php echo base_url(); ?>Teacherdashboard/Addacademicnote" class="nav-link ">
	                                        <span class="title">Add Note Book</span>
	                                    </a>
	                                </li>
                                    <li class="nav-item ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addacademicnote/view_academic_note" class="nav-link ">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addhomework" class="nav-link ">
                                            <span class="title">Add Home Work </span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Addhomework/view_home_work" class="nav-link ">
                             ...
                             <li class="nav-item">
                                <a href="#" class="nav-link nav-toggle">
                                    <i class="material-icons">dashboard</i>
                                    <span class="title">Student Home Work</span>
                                    <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Adminusers/About" class="nav-link ">
                                            <span class="title">View Student Home-Work</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                              ...
                              <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Studentnotice" class="nav-link ">
                                            <span class="title">Add Notice</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo base_url(); ?>Teacherdashboard/Studentnotice/viewnotice" class="nav-link ">
                              ...
                              <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="#" class="nav-link ">
                                            <span class="title">Add Video Course</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="#" class="nav-link ">
                                            <span class="title">All Video Course</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
