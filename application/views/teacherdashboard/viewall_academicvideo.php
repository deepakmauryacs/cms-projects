                                       ...
                                       <td><?php echo $row->status ; ?></td>
                                                <td>
                                                    <a class="btn btn-tbl-edit btn-xs" data-toggle="modal" data-target="#largeModel<?=$row->id?>">
                                                     ...
                                                     <a onclick="return confirm('Are you sure?')"  href="<?php echo base_url().'Teacherdashboard/Addacademicvideo/delete_academicvideo/'.$row->id  ?>" class="btn btn-tbl-delete btn-xs">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <form action="<?php echo base_url('Teacherdashboard/Addacademicvideo/update_academicvideo');?>" method="post" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <option value="8<">Class 10</option>
                                            <option value="8<">Class 11</option>
                                            <option value="8<">Class 12</option>
                                           </select>
                                            </div>
                                        </div>
