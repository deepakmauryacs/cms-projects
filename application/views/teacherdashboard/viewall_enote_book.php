                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">All E Note-Book</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">E Note-Book</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">All E Note-Book</li>
                            </ol>
                        </div>
                    </div>
                                       ...
                                       <td><?php echo $row->note ; ?></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-tbl-edit btn-xs" data-toggle="modal" data-target="#largeModel<?=$row->id?>">
                                                     ...
                                                     <a onclick="return confirm('Are you sure?')"  href="<?php echo base_url().'Teacherdashboard/Addacademicnote/delete_academic_note/'.$row->id  ?>" class="btn btn-tbl-delete btn-xs">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <form action="<?php echo base_url('Teacherdashboard/Addacademicnote/update_academic_note');?>" method="post" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
