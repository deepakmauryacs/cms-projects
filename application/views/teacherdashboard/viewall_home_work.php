                                       ...
                                       <td><?php echo $row->note ; ?></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-tbl-edit btn-xs" data-toggle="modal" data-target="#largeModel<?=$row->id?>">
                                                     ...
                                                     <a onclick="return confirm('Are you sure?')"  href="<?php echo base_url().'Teacherdashboard/Addhomework/delete_home_work/'.$row->id  ?>" class="btn btn-tbl-delete btn-xs">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <form action="<?php echo base_url('Teacherdashboard/Addhomework/update_home_work');?>" method="post" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                        <div class="form-body">
                                           
                                            

                                              <div class="form-group row">
                                                <label class="control-label col-md-3">Old Home Work
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Home Work
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-6">
                                           ...
                                           <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="subjectname" value="<?php echo $row->subjectname ; ?>" data-required="1"  class="form-control input-height"> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="date" name="date" data-required="1" value="<?php echo $row->date ; ?>"  class="form-control input-height"  > </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                <textarea name="note" class="ckeditor" rows="3" >
                                                     <?php echo $row->note ; ?>
                                                </textarea>
                                            </div>
                                           </div>
